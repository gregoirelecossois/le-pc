...
export const CHAPTERS: Chapter[] = [
  {
    ...
    goal: "La machine est montée. Écarte les pièces avec le curseur du haut, puis clique sur les composants DANS LA MACHINE pour découvrir leur fiche. Trouve-les tous !",
